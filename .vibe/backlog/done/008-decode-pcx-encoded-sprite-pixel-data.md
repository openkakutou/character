...
## Acceptance Criteria
- [x] A known PCX-encoded sprite fixture decodes to the expected pixel buffer
- [x] RLE run-length edge cases (e.g. runs at buffer boundaries) decode correctly
- [x] Corrupted/truncated PCX data returns a descriptive error rather than panicking
